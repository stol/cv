...
$experiences = [
    [
        ...
        'intro' => "Prise de poste dans un contexte compliqué, suite au départ du précédent CTO.",
        'tasks' => [
            'Reprise en main d\'une équipe (~ 15 devs)',
            'Analyse de l\'activité et réorganisation en petites équipes dédiées.',
            'Mise en place d\'une méthodologie agile de type Scrum, build/run et de tableaux JIRA.',
            'Amélioration de la communication avec la maison mère à Amsterdam',
            '4 recrutements (1 PO, 3 développeurs front-end, 1 développeur back-end) sur 6 postes ouverts.',
            'Anglais quotidien',
        ...
        'tasks' => [
            ...
            "Maintien d'une codebase performante et gestion des urgences.",
        ],
...
*/
        ...
        'start' => "2015-11-01",
        'end' => "2022-03-26",
        'job' => 'CTO (pôle food, initialement)',
        'company' => 'Webedia',
        'link' => 'http://www.750g.com',
        'area' => 'Paris',
        'intro' => "Les projets listés ci-dessous m'ont été confiés au fil du temps, avec comme point d'orgue l'année 2021, où j'ai été nommé CTO adjoint d'un nouveau pôle d'une centaine de développeurs.",
        'tasks' => [
            'Management et/ou animation d\'équipes françaises et internationales (~ 15 développeurs) intervenant sur divers projets',
            '<a href="https://www.tudogostoso.com.br/" target="_blank">tudogostoso.com.br</a> : site communautaire brésilien, thématique cuisine, 50 millions visiteurs/mois',
            '<a href="https://www.750g.com/" target="_blank">750g.com</a> : site communautaire, thématique cuisine, 15 millions visiteurs/mois',
            '<a href="https://www.academiedugout.fr" target="_blank">academiedugout.fr</a> : site e-commerce thématique cuisine, 1 million visiteurs/mois',
            '<a href="https://www.pourdebon.com/" target="_blank">pourdebon.com</a> : place de marché de produits alimentaires, 0.5 million visiteurs/mois',
